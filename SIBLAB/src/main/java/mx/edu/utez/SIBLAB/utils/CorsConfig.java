...
public class CorsConfig extends WebMvcConfigurerAdapter {
    ...
    public CorsFilter corsFilter() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:3000", "http://192.168.100.8:19000"));
        config.setAllowedOrigins(List.of("http://localhost:3000", "http://192.168.100.8:19000"));
